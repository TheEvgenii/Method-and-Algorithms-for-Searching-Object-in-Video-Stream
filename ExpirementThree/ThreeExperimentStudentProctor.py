#
#  ThreeExerimentStudentProctor.py
#  Evgenii_Litvinov
#  COSC4399
#  Code was written in Python language
#  Created by Evgenii Litvinov on 03/17/23.
#
...
# Access webcam 
cap = cv2.VideoCapture("SecondShenariyLeft1.mp4")
cap1 = cv2.VideoCapture("SecondShenariyLeft2.mp4")
